    ...
    <div class="create-post-container">
        <div class="create-post-card" data-sal-delay="150" data-sal-duration="800" data-sal="slide-up">
            <div class="post-header">
                ...
                <h2 class="title">Mise à jour du Post</h2>
                <p class="disc">Partagez vos pensées, questions ou expériences avec la communauté</p>
            </div>

            <form  action="../../controller/modifierSujetController.php?id=<?=$id?>&position=front" method="POST" >
                ...
                <div class="post-actions">
                   <button type="button"
    onclick="window.location.href='../../controller/supprimerSujetController.php?id=<?= $id ?>&position=front';"
    class="btn-cancel">
    <i class="fas fa-arrow-left"></i> Supprimer
</button>

                    <button type="button" class="btn-cancel" id="previewBtn">
                        <i class="fas fa-eye"></i> Aperçu
                    </button>
                    <button type="submit" onclick="window.location.href='../../controller/modifierSujetController.php?id=<?=$id?>?contenu=<?=$nom?>&position=front'" class="btn-submit">
                        <i class="fas fa-paper-plane"></i> Modifier le Post
                    </button>
                </div>
            </form>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pl_lg--80">
                    <div class="footer-single-wized">
                        ...
                        <ul class="wizid-lists">
                            <li class="item"><a href="forum.html">Forum</a></li>
