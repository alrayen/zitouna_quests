...
try {
    ...
    $base_path = '/Projet2';
    $redirect_url = ($_SESSION['user_role'] === 'admin') ? $base_path . "/View/BACK%20OFFICE/VIEW/build/pages/dashboard.html" : $base_path . "/View/FRONT%20OFFICE/PRINCIPAL/genifty-html/index.php";
