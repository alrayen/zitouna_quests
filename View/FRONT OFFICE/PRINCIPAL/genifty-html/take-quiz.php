...
<body>
                ...
                <div class="col-xl-5 d-xl-block d-none">
                    <div class="main-menu-wrapepr">
                        <nav class="mainmenu-nav d-none d-xl-block">
                            <ul class="main-menu">
                                <li class="single-items off-arrow"><a class="navmain" href="index.php">Home</a></li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // --- 1. QUIZ DATA ---
            // This is where you'll put your questions.
            // Eventually, you can fetch this from your database.
            const quizData = [
                {
                    question: "Computer Hard Disk was First introduces in 1956 by:",
                    answers: [
                ...
                {
                    question: "The largest country by geographical area is:",
                    answers: [
                ...
                },
                {
                    ...
                    answers: [
                        { text: "Water Vapours", correct: true },
            ...
            let timerInterval;
            let timeRemaining = 60; // 60 seconds per quiz (you can change this)
