...
<style>
    ...
    /* Style for the "Enregistrer" Button */
    .button-group .rts-btn.btn-primary {
        ...
        border-radius: 10px;
        border: none;
        background: #fff; /* Solid white for a strong CTA */
        color: #00796B; /* A dark green from your background */
        cursor: pointer;
        transition: all 0.3s ease;
    }
            ...
            <div class="form-group">
                ...
                <div class="photo-upload-wrapper">
                    <div class="photo-preview-container">
                        <?php 
                        $photoPath = 'assets/images/team/team-01.png'; // Default
                        if (!empty($photo)) {
